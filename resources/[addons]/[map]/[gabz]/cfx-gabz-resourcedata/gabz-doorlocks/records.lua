...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.5,
	doors = {
		{objHash = 2001816392, objHeading = 270.00003051758, objCoords = vector3(-826.4025, -700.9301, 28.49083)},
		{objHash = 2001816392, objHeading = 89.999977111816, objCoords = vector3(-826.4025, -698.7478, 28.49083)}
 },
	lockpick = false,
	audioRemote = false,
	slides = false,
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.5,
	doors = {
		{objHash = 2001816392, objHeading = 270.00003051758, objCoords = vector3(-826.4025, -697.9944, 28.49083)},
		{objHash = 2001816392, objHeading = 89.999977111816, objCoords = vector3(-826.4025, -695.8148, 28.49083)}
 },
	lockpick = false,
	audioRemote = false,
	slides = false,
...
table.insert(Config.DoorList, {
	...
	lockpick = false,
	doors = {
		{objHash = 75593271, objHeading = 0.0, objCoords = vector3(-822.3143, -703.1263, 28.2056)},
		{objHash = 1403720845, objHeading = 0.0, objCoords = vector3(-820.3126, -703.1263, 28.2056)}
 },
	audioRemote = false,
	authorizedJobs = { ['records']=0 },
	slides = false,		
...
table.insert(Config.DoorList, {
	...
	lockpick = false,
	doors = {
		{objHash = 75593271, objHeading = 0.0, objCoords = vector3(-822.3143, -715.694, 28.2056)},
		{objHash = 1403720845, objHeading = 0.0, objCoords = vector3(-820.3126, -715.694, 28.2056)}
 },
	audioRemote = false,
	authorizedJobs = { ['records']=0 },
	slides = false,		
...
table.insert(Config.DoorList, {
	...
	lockpick = false,
	doors = {
		{objHash = 1403720845, objHeading = 89.999977111816, objCoords = vector3(-823.145, -708.4457, 32.4866)},
		{objHash = 75593271, objHeading = 89.999977111816, objCoords = vector3(-823.145, -710.4473, 32.4866)}
 },
	audioRemote = false,
	authorizedJobs = { ['records']=0 },
	slides = false,		
