...
SetVestIfNone = false, -- Sets a vest to a player when armor used
...
AttachmentStoreBlipName = 'Magasin d\'Accessoires ',
...
function SendMessage(msg)
	...
	--	exports['mythic_notify']:SendAlert('inform', msg)
		exports['okokNotify']:Alert("Citizen-V", msg, 5500, 'info')
