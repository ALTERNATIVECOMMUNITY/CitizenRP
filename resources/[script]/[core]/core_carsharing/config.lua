...
Config = {
	...
	vehiclePlateText = "LOCATION", -- IMPORTANT: Change this to any text with less then 8 characters

	vehicleSpawnRate = 20, -- Seconds to wait in zone until vehicle spawns

	vehicleUnlockFee = 300.0, -- The price paid to unlock a vehicle
	...
	ZoneBlipDisplay = 326,
	ZoneBlipColor = 3,
	ZoneBlipText = "Voiture sans permis",
...
--- AIRPOT
		{
			Center = vector3(-1031.9036865234,-2726.5903320312,13.75661277771), -- Center of the zone
			Size = 30.0,        -- Size of the zone
			SpawnPoints = {     -- Spawn points must be inside the zone!

				{x = -1052.4217529297, y = -2712.2956542969, z = 13.673711776733, h =234.32},
				{x = -1040.6871337891, y = -2719.0666503906, z = 13.674066543579, h =234.32},
				{x = -1024.02, y = -2728.68, z = 13.674066543579, h =234.32},
				{x = -1012.9, y = -2735.23, z = 13.674066543579, h =234.32},
	...
	Vehicles = {
		...
		{
			Display = "Brioso", -- Display name of vehicle (Ex. BMW X5 2019)
			Model   = "brioso2", -- Model name of the car used to spawn vehicle
			Price   = 20.0,      -- Price per minute
		},
		{
			Display = "Brioso", -- Display name of vehicle (Ex. BMW X5 2019)
			Model   = "brioso2", -- Model name of the car used to spawn vehicle
			Price   = 23.0,      -- Price per minute
		},
		{
			Display = "Brioso", -- Display name of vehicle (Ex. BMW X5 2019)
			Model   = "brioso2", -- Model name of the car used to spawn vehicle
			Price   = 30.0,      -- Price per minute
		}
	...
	Text = {
		...
		['serviceName']  = "Voiture sans permis",
		['vehicleUnlocked'] = "Le véhicule a été déverrouillé ! ~b~Conduisez prudemment",
		['noMoneyOrLicense'] = "Vous n&#39;avez pas assez d&#39;argent ou un permis valide!",
		['paid'] = "Vous avez payé ~b~{price} $~w~ pour votre trajet!",
		['badParking'] = "Le véhicule a été retiré en raison d&#39;un stationnement à l&#39;extérieur d&#39;une zonee",
		['penaltyPaid'] = "Vous avez payé ~b~{penaltyPrice} $~w~ pour garer le véhicule en dehors d&#39;une zone",
		['damagePenalty'] = "Vous avez payé ~b~{penaltyPrice} $~w~ pour avoir endommagé le véhicule",
		['pricePerMinute'] = "1 Minute | ${price}",
		['vehicleInfo'] = "Véhicule : {info}",
		['unlockText'] = "Pour déverrouiller, appuyez sur [ G ] pour ${price}",
		['zoneInfo'] = "Pendant que vous êtes dans la zone, des véhicules apparaîtront !",
		['zoneTitle'] = "Voiture sans permis"
