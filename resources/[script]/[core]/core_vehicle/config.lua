...
MechanicWorkshop = { -- Mechanic Workshops where mechanics can use MechanicWorkshopAccess
    ...
    {coords = vector3(-1416.8216552734,-446.44439697266,35.90966796875), radius = 20.0}
...
Text = {
    ...
    ['hood_closed'] = 'Le capot est fermé!',
    ['mechanic_action_complete'] = 'Réparation terminée',
    ['mechanic_action_started'] = 'La réparation a commencé',
    ['wrong_job'] = 'Travail incorrect',
    ['not_enough'] = 'Pas assez d&#39;objets'
