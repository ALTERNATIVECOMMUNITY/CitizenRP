...
RegisterCommand(
    ...
    function(source, args, rawCommand)
       ...
       TriggerServerEvent('core_dispach:changeCallSign', args[1])
...
function ToggleDuty() 
        ...
        TriggerServerEvent('core_multijob:changeJob', 'offduty', 0)
end
...
exports(
    ...
    function(code, title, extraInfo, coords, job, cooldown, sprite, color)
        TriggerServerEvent("core_dispach:addCall", code, title, extraInfo, coords, job, cooldown or 25000, sprite or 11, color or 5)
    end
)
...
exports(
    ...
    function(message, coords, job, cooldown, sprite, color)
        TriggerServerEvent("core_dispach:addMessage", message, coords, job, cooldown or 25000, sprite or 11, color or 5)
    end
)
