...
Config.CloseOnUse = {
    ...
    "toolbox",
    "towing_rope"
} -- all items in this array will close the inventory when used
...
Config.HotbarKeys = {
    ...
    160,
    164
} -- hotbar keys (1,2,3,4) (FiveM Keys)
...
Config.BlacklistedItems = {
    ...
    "",
    ""
} -- will not allow the robber to remove items that are put in this array
...
Config.BlacklistedVehicleTypesGB = {
    13,
    8
} -- vehicle types that should not have a glovebox
