    ...
    TriggerEvent('skinchanger:getSkin', function(skin)
        if skin.sex == 0 then
            local maleSkin = {
                ...
                ['mask_1'] = 36, ['mask_2'] = 0,
                ['arms'] = 15,
                ['pants_1'] = 16, ['pants_2'] = math.random(0, 10),
    ...
    TriggerEvent('skinchanger:getSkin', function(skin)
        if skin.sex == 0 then
            local maleSkin = {
                ['tshirt_1'] = 15, ['tshirt_2'] = 0,
                ['ears_1'] = -1, ['ears_2'] = 0,
                ['torso_1'] = 243, ['torso_2'] = math.random(0, 25),
                ['decals_1'] = 0, ['decals_2'] = 0,
                ['mask_1'] = 0, ['mask_2'] = 0,
                ['arms'] = 17,
            ...
            local femaleSkin = {
                ...
                ['ears_1'] = -1, ['ears_2'] = 0,
                ['torso_1'] = 251, ['torso_2'] = math.random(0, 25),
                ['decals_1'] = 0, ['decals_2'] = 0,
                ['mask_1'] = 0, ['mask_2'] = 0,
                ['arms'] = 36,
...
Citizen.CreateThread(function()
    while true do
        ...
        if currentSpot ~= nil and #pickupPoints > 0 and ((ESX and ESX.PlayerData.job and ESX.PlayerData.job.name == 'diver') or not Config.diverJobOnly) then
...
Citizen.CreateThread(function()
    function createNewLoot()
        ...
        if GetDistanceBetweenCoords(playerCoords, x, y, z, true) < 25.0 then
            createNewLoot()
        else
            createLoot(lootLoc, x, y, z)
        end
