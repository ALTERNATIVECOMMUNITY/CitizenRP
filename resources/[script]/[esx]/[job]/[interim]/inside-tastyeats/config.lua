...
icfg.TastyEats = {
    ...
    ["RandomText"] = {
        [1] = {NPCText = "Salut, j'espère que la nourriture est encore chaude", NPCText2 = "Merci beaucoup!", YourText = "[~g~E~s~] - bonjour bien sur"},
        [2] = {NPCText = "Salut, après tout tu es...", NPCText2 = "Merci beaucoup!", YourText = "[~g~E~s~] - Oui... Salut, bon appétit"},
        [3] = {NPCText = "Salut, je n'ai pas eu de nourriture livrée aussi rapidement de ma vie", NPCText2 = "I have to Order Food from you more and more often!", YourText = "[~g~E~s~] - Hello, nice to hear it!"},
        [4] = {NPCText = "Bonjour, je payais pour une commande en ligne", NPCText2 = "Au revoir!", YourText = "[~g~E~s~] - Salut, d'accord"},
    },
