            ...
            if PlayerData.job ~= nil and PlayerData.job.name == 'tastyeats' then
                ...
                if onDuty then
                                ...
                                elseif IsControlJustReleased(0, Keys["Y"]) then
                                    ...
                                    ESX.TriggerServerCallback('inside-tastyeats:checkMoney', function(hasMoney)
                                        ...
                                        elseif not hasMoney then
                                            ...
                                            exports.pNotify:SendNotification({text = "<b>Tasty Eats</b></br></br>Vous n'avez pas assez d&#39;argent pour payer la caution du véhicule ! Frais: " ..icfg.DepositForVehiclePrice.. "$", timeout = 2000})
                    ...
                    elseif hasCar then
                        ...
                        if IsPedInAnyVehicle(ped, false) then
                            ...
                            if (#(coords - vector3(icfg.TastyEats["Base"].Garage.Coords.ReturnVehicle.x, icfg.TastyEats["Base"].Garage.Coords.ReturnVehicle.y, icfg.TastyEats["Base"].Garage.Coords.ReturnVehicle.z)) < 1.6) then
                                ...
                                refresh = 4
                                DrawText3D(coords.x, coords.y, coords.z + 1.2, "Appuyez sur [~r~E~s~] pour rendre le véhicule")
                                ...
                                if IsControlJustReleased(0, Keys["E"]) and not block then
                                    ...
                                    if veh == WorkVeh then
                                        ...
                                        exports.pNotify:SendNotification({text = "<b>Tasty Eats</b></br></br>" ..icfg.DepositForVehiclePrice.. "$ a été retourné sur votre compte bancaire", timeout = 2000})

                                    else

                                        exports.pNotify:SendNotification({text = "<b>Tasty Eats</b></br></br>Ce n'est pas le véhicule pour lequel vous avez payé une caution", timeout = 2000})
                    ...
                    elseif inOrderMenu then
                        ...
                        refresh = 4
                        DrawText3D(coords.x, coords.y, coords.z + 1.0, "[~g~Q~s~] - Ordre de recherche | [~r~Y~s~] Annuler la commande")
