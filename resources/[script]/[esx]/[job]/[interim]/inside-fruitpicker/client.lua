            ...
            if not onDuty then
                if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 10) then
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 1.5) then
                        sleep = 6
                        DrawText3D(Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z + 0.4, '~g~[E]~s~ - Se changer en vêtements de travail')
                        if IsControlJustPressed(0, Keys["E"]) then
                            if not InVehicle then
                                exports.rprogress:Custom({
                                    Duration = 2500,
                                    Label = "Tu changes de vêtements...",
                                    Animation = {
                                ...
                                exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br>Vous avez commencé à travailler!", timeout = 3000})
                                onDuty = true
                                blips()
                                end)
                            else
                                exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br>Laissez le véhicule!", timeout = 1500})
                            end
                        end
                    end
                end
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 1.5) then
                        ...
                        if IsControlJustPressed(0, Keys["E"]) then
                            if not InVehicle then
                                ...
                                exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br>Tu as fini le travail!", timeout = 3000})
                                onDuty = false
                                working = false
                                hasWashed = false
                                hasBox = false
                                ...
                                exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br>Quitter le véhicule!", timeout = 1500})
                            end
                        end
                    end
                end
                        ...
                        if InVehicle then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                if hasCar then
                                    ...
                                    exports.pNotify:SendNotification({text = "<b>Fruit Picker</b></br>Vous n'avez pas payé d'acompte pour ce véhicule", timeout = 1500})
                                end
                            end
                        elseif not InVehicle then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                ...
                                if hasMoney then
                                    ...
                                    exports.pNotify:SendNotification({text = '<b>Fruit Picker</b></br>Vous avez payés ' ..Config.DepositPrice.. '$ pour sortir le véhicule', timeout = 1500})
                                    Plate = GetVehicleNumberPlateText(vehicle)
																			exports['t1ger_keys']:GiveJobKeys(Plate, 'Saisonier', true)
                                    hasCar = true
                                    working = true
                                    BlipsWorking()
                                    for i, v in ipairs(Config.OrangeSpots) do
                                    ...
                                    exports.pNotify:SendNotification({text = "<b>Fruit Picker</b></br>Vous n'avez pas assez d'argent", timeout = 1500})
                                end
                                end)
                            end
                        end
                            ...
                            local trunkpos = GetOffsetFromEntityInWorldCoords(vehicle, 0, -1.5, 0)
                                if not hasBox then
                                    if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, trunkpos.x, trunkpos.y, trunkpos.z, true) < 1.5 then
                                        sleep = 6
                                        DrawText3D(trunkpos.x, trunkpos.y, trunkpos.z + 0.4, "~g~[G]~s~ - Panier à emporter")
                                ...
                                elseif hasBox then
                                    ...
                                    if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, trunkpos.x, trunkpos.y, trunkpos.z, true) < 1.5 then
                                        sleep = 6
                                        DrawText3D(trunkpos.x, trunkpos.y, trunkpos.z + 0.4, "~r~[G]~s~ - Mettre dans le panier")
                                        if IsControlJustReleased(0, Keys["G"]) then
                                            sleep = 20
            ...
            if working then
                            ...
                            if IsControlJustPressed(0, Keys["E"]) then
                                if not InVehicle then
                                    if hasBox then
                                        ...
                                        RemoveBlip(v.blip)
                                        if done == 12 then
                                            exports.pNotify:SendNotification({text = '<b>Cueilleur de Fruits</b></br>Vous avez ramassé tous les fruits du verger, lavez-les maintenant', timeout = 5000})
                                        ...
                                        exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br>Vous n'avez pas de panier", timeout = 3000})
                                    end
                                else
                                    exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br>Quitter le véhicule!", timeout = 1500})
                                end
                ...
                for i, v in ipairs(Config.AppleSpots) do
                    if not v.taked then
                        if GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 3 then
                            sleep = 6
                            DrawText3D(v.x, v.y, v.z + 0.4, '~g~[E]~s~ - Cueillir des pommes')
                            if IsControlJustPressed(0, Keys["E"]) then
                                if not InVehicle then
                                    if hasBox then
                                        ESX.Streaming.RequestAnimDict('amb@prop_human_movie_bulb@idle_a', function()
                                    ...
                                    exports.pNotify:SendNotification({text = "<b>Picke aux Fruitsr</b></br>Quitter le véhicule!", timeout = 1500})
                                end
                            end
                        end
                    end
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["transformfruit"].coords.x, Config.Locations["transformfruit"].coords.y, Config.Locations["transformfruit"].coords.z, true) < 2.5) then
                        ...
                        if IsControlJustPressed(0, Keys["E"]) then
                            if done == 12 then
                                if not InVehicle then
                                    if hasBox then
                                        if not hasWashed then
                                            ...
                                            DoScreenFadeIn(800)
                                            Citizen.Wait(800)
                                            exports.pNotify:SendNotification({text = '<b>Cueilleur de Fruits</b></br>Vos fruits sont prêts à être vendus, rendez-vous au magasin', timeout = 5000})
                                        ...
                                        elseif hasWashed then
                                            exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br> Vos fruits sont déjà lavés", timeout = 3000})
                                        end
                                    else
                                        exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br>Vous n'avez pas de panier", timeout = 3000})
                                    end
                                ...
                                exports.pNotify:SendNotification({text = "<b>Picke aux Fruits</b></br>Vous n'avez pas ramassé tous les fruits du verger!", timeout = 3000})
                            end
                        end
                    end
                end
                            ...
                            if not InVehicle then
                                if hasBox then
                                    if hasWashed then
                                        ...
                                        exports.pNotify:SendNotification({text = '<b>Cueilleur de Fruits</b></br>Vos fruits ne sont pas lavés!', timeout = 3000})
                                    end
                                else
                                    exports.pNotify:SendNotification({text = "<b>Cueilleur de Fruits</b></br>Vous n'avez pas de panier", timeout = 3000})
                                end
...
function BlipsWorking()
    for i, v in ipairs(Config.OrangeSpots) do
        ...
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentSubstringPlayerName('Verger d\'Oranges')
    ...
    for i, v in ipairs(Config.AppleSpots) do
        ...
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentSubstringPlayerName('Verger de Pommes')
        EndTextCommandSetBlipName(v.blip)
    end
    ...
    for i, v in ipairs(Config.StrawberrySpots) do
        ...
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentSubstringPlayerName('Verger de Fraises')
        EndTextCommandSetBlipName(v.blip)
    end
end
...
function DepositBack()
    ...
    ESX.Game.DeleteVehicle(vehicle)
		exports['t1ger_keys']:GiveJobKeys(Plate, name, false)
    hasCar = false
end
