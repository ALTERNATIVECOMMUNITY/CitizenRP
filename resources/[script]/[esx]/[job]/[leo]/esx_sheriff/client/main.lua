...
{label = 'Badge Civil - Cou' , uniform = 'badge_cou'},
{label = 'Badge Civil - Ceinture' , uniform = 'badge_ceinture'},
{label = 'Badge Civil - Cuisse' , uniform = 'badge_cuisse'}
	}

		table.insert(elements, {label = '---GILETS---' , uniform = ''})
		table.insert(elements, { label = 'Gilet Tactique', uniform = 'gilet_wear'})
		table.insert(elements, {label = 'Porte Plaque Patrouille', uniform = 'bullet_wear'})
	...
	--	table.insert(elements, {label = 'Bonet' , uniform = 'bonet'})
		...
		if ESX.PlayerData.job.grade_name == 'recruit' then
				...
				table.insert(elements, {label = "Tenue de service", uniform = 'recruit'})


			end

					if ESX.PlayerData.job.grade_name == 'patrouilleur' then

							table.insert(elements, {label = "Tenue de service", uniform = 'pat'})
								table.insert(elements, {label = "Tshirt patrouille", uniform = 'tshirt_pat'})
								table.insert(elements, {label = "Veste de patrouille", uniform = 'jacket_norm'})
								table.insert(elements, {label = "Veste Haute Visibilité", uniform = 'jacket_jaune'})


						end

											if ESX.PlayerData.job.grade_name == 'caporal' then

													table.insert(elements, {label = "Tenue de service", uniform = 'caporal'})
														table.insert(elements, {label = "Tshirt patrouille", uniform = 'tshirt_pat'})
														table.insert(elements, {label = "Tshirt K9", uniform = 'tshirt_canine'})
														table.insert(elements, {label = "Veste de patrouille", uniform = 'jacket_norm'})
														table.insert(elements, {label = "Veste Haute Visibilité", uniform = 'jacket_jaune'})
												...
												if ESX.PlayerData.job.grade_name == 'sergeant' then
														...
														table.insert(elements, {label = "Tenue de service", uniform = 'sergeant'})
															table.insert(elements, {label = "Tshirt patrouille", uniform = 'tshirt_pat'})
															table.insert(elements, {label = "Tshirt Narco", uniform = 'tshirt_narco'})
																table.insert(elements, {label = "Tshirt K9", uniform = 'tshirt_canine'})
																table.insert(elements, {label = "Veste de patrouille", uniform = 'jacket_norm'})
																table.insert(elements, {label = "Veste Haute Visibilité", uniform = 'jacket_jaune'})
													...
													if ESX.PlayerData.job.grade_name == 'detective' then

															table.insert(elements, {label = "Tenue de service", uniform = 'det'})
																table.insert(elements, {label = "Tshirt patrouille", uniform = 'tshirt_pat'})
																table.insert(elements, {label = "Tshirt Narco", uniform = 'tshirt_narco'})
																	table.insert(elements, {label = "Tshirt K9", uniform = 'tshirt_canine'})
																	table.insert(elements, {label = "Tshirt Enqueteur", uniform = 'tshirt_crime'})
																	table.insert(elements, {label = "Veste de patrouille", uniform = 'jacket_norm'})
																	table.insert(elements, {label = "Veste Haute Visibilité", uniform = 'jacket_jaune'})
														...
														if ESX.PlayerData.job.grade_name == 'lieutenant' then
																...
																table.insert(elements, {label = "Tenue de service", uniform = 'lieutenant'})
																	table.insert(elements, {label = "Tshirt patrouille", uniform = 'tshirt_pat'})
																	table.insert(elements, {label = "Tshirt Narco", uniform = 'tshirt_narco'})
																		table.insert(elements, {label = "Tshirt K9", uniform = 'tshirt_canine'})
																		table.insert(elements, {label = "Tshirt Enqueteur", uniform = 'tshirt_crime'})
															...
															if ESX.PlayerData.job.grade_name == 'boss' then
																	...
																	table.insert(elements, {label = "Tenue de service", uniform = 'boss'})
																		table.insert(elements, {label = "Tshirt patrouille", uniform = 'tshirt_pat'})
																			table.insert(elements, {label = "Tshirt Narco", uniform = 'tshirt_narco'})
																				table.insert(elements, {label = "Tshirt K9", uniform = 'tshirt_canine'})
																				table.insert(elements, {label = "Tshirt Enqueteur", uniform = 'tshirt_crime'})
