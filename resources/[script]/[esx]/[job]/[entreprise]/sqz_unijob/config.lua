...
Config.Jobs.fish = { -- This is name of job you have in your database, change to setjob name whatever you want to
    ...
    Zones = {
        ...
        Cloakroom = {
            Pos = {
                ...
                y = 2072.6687011719,
                z = 140.38768005371
            }, -- This is the place where you can change your saved clothes (you have to buy then in clotheshop)
            Size = {
                x = 0.7,
                y = 0.7,
                z = 0.7
            ...
            RequiredItems = { -- Bellow will be listed items a player will need for Collecting
                {
                    ...
                    count = 10,
                    removeItem = true
                } -- itemName is the name from database, removeItem will remove the item from player inventory after fininished collecting
        ...
        BossActions = {
            Pos = {
                ...
                y = 2044.3988037109,
                z = 140.79180908203
            }, -- This is the place where you open BossMenu (only grade with name boss is allowed (depends on your esx_society edits)
            Size = {
                x = 0.7,
                y = 0.7,
                z = 0.7
        ...
        Vehicles = {
            Pos = {
                ...
                y = 3705.44,
                z = 34.18
            }, -- This is the spawnpoint where you see menu with vehicles which you can spawn
            Size = {
                x = 0.7,
                y = 0.7,
                z = 0.7
            ...
            SpawnPoints = { -- Here you configure spawnpoints, where the vehicle will be spawned (Chcecks if the spawnpoint is clear), you can add as much as you want
                {
                    coords = vector3(1722.02, 3713.56, 34.22),
                    heading = 90.0,
                    radius = 6.0
                },
                {
                    coords = vector3(1726.88, 3716.97, 34.13),
                    heading = 90.0,
                    radius = 6.0
                }
            }
    ...
    CollectPoints = { -- Places where a player can pickup an item
        ...
        {
            pos = vector3(-4049.7385253906, 8267.837890625, 0.83003795146942), -- The position of the marker
            isUsed = false, -- Just do not touch it :)
            getMin = 2, -- The min count a player will get
            getMax = 4, -- The max item count a player will get
            getItem = "fish" -- Item a player will get
        },
        {
    ...
    DefaultClothes = {
        ...
        ["Work Outfit"] = {
            ...
            male = { -- Set the clothes for male peds
                tshirt_1 = 0,
                tshirt_2 = 0, -- You can remove or add any lines,
                torso_1 = 0,
                torso_2 = 0, -- That your skinchanger script supports
                decals_1 = 0,
                decals_2 = 0,
                arms = 0,
                pants_1 = 0,
        ...
        shared = { -- These vehicles will have in garage every job rank
            {
                ...
                props = {
                    plate = 'SQZ2',
                    modXenon = false
                } -- Here you can add all vehicle mods you want, documentation can be found here: https://esx-framework.github.io/es_extended/client/functions/game/setvehicleproperties/#valid-table-content
            },
            {
                model = 'slavman',
                label = 'SlawMan',
...
Config.Jobs.brinks = { -- This is name of job you have in your database
    ...
    Zones = {
        ...
        HeliSpawn = { -- This is marker which opens you menu where you choose which plane you want to spawn.
            ...
            SpawnPoints = { -- Here you configure spawnpoints, where the vehicle will be spawned (Chcecks if the spawnpoint is clear), you can add as much as you want, smae as vehicles
                {
                    coords = vector3(449.84, -981.04, 43.69),
                    heading = 93.96,
                    radius = 6.0
                }
            }
