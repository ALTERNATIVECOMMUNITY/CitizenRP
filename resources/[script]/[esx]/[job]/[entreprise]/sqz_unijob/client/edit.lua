...
RegisterNetEvent('sqz_unijob:CustomElementJobMenu')
AddEventHandler('sqz_unijob:CustomElementJobMenu', function(type)
    -- This event will be triggered aftter calling a specific action in the Job Actions menu
    -- type:
    
    -- billing: is for billing

    --   handcuff: is handcuffing
    --   search: is searching
    --   uncuff: is uncuffing
    --   drag: is dragging
    --   putIV: is putting into a vehicle
    --   outOV: is putting out of a vehicle

    --   hijack: is hijacking a vehicle
    --   fix: is fixing a vehicle
    --   clean: is cleaning of a vehicle
    --   impound: is imponding a vehicle
    --   dep: is attaching a vehicle on the flatbed
