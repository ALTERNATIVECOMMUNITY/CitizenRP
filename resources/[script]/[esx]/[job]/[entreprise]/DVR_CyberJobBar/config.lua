...
-------- SHOPS --------
    ...
    Flacons = {
        Pos   = { x = -703.01, y = -917.09, z = 18.31 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        Color = { r = 238, g = 0, b = 0 },
        Type  = 23,
        Items = {
            { name = 'patochebeer',             label = _U('patochebeer'),          price = 30 },
            { name = 'dvrcocktail',             label = _U('dvrcocktail'),          price = 40 },
            { name = 'milkdragon',              label = _U('milkdragon'),           price = 2 },
            { name = 'duffbeer',                label = _U('duffbeer'),             price = 7 },
            { name = 'jamesbondcocktail',       label = _U('jamesbondcocktail'),    price = 2 },
            { name = 'scarfacecolada',          label = _U('scarfacecolada'),       price = 5 },
            { name = 'onepunchman',             label = _U('onepunchman'),          price = 5 },
            { name = 'dragonballcocktail',      label = _U('dragonballcocktail'),   price = 5 },
            { name = 'hulkcockail',             label = _U('hulkcockail'),          price = 5 },
            { name = 'vitodaiquiri',            label = _U('vitodaiquiri'),         price = 5 },
            { name = 'marvelcocktail',          label = _U('marvelcocktail'),       price = 5 },
            { name = 'yoshishooter',            label = _U('yoshishooter'),         price = 5 }
        },
    },
}
