...
AddEventHandler('esx_mechanicjob:startHarvest', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('recovery_gas_can')})
	Harvest(source)
end)
...
AddEventHandler('esx_mechanicjob:startHarvest2', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('recovery_repair_tools')})
	Harvest2(_source)
end)
...
AddEventHandler('esx_mechanicjob:startHarvest3', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('recovery_body_tools')})
	Harvest3(_source)
end)
...
AddEventHandler('esx_mechanicjob:startCraft', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('assembling_blowtorch')})
	Craft(_source)
end)
...
AddEventHandler('esx_mechanicjob:startCraft2', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('assembling_repair_kit')})
	Craft2(_source)
end)
...
AddEventHandler('esx_mechanicjob:startCraft3', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('assembling_body_kit')})
	Craft3(_source)
end)
...
AddEventHandler('esx_mechanicjob:onNPCJobMissionCompleted', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('your_comp_earned').. total })
end)
...
ESX.RegisterUsableItem('blowpipe', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('you_used_blowtorch') })
end)
...
ESX.RegisterUsableItem('fixkit', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('you_used_repair_kit') })
end)
...
ESX.RegisterUsableItem('carokit', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = _U('you_used_body_kit') })
end)
