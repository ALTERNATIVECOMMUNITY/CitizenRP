...
RegisterNetEvent('esx_extraitems:bulletproof1')
AddEventHandler('esx_extraitems:bulletproof1', function()
	local playerPed = GetPlayerPed(-1)
	SetPedComponentVariation(playerPed, 9, 7, 2, 2)
	AddArmourToPed(playerPed, 50)
	SetPedArmour(playerPed, 50)
end)


RegisterNetEvent('esx_extraitems:bulletproof2')
AddEventHandler('esx_extraitems:bulletproof2', function()
	local playerPed = GetPlayerPed(-1)
	SetPedComponentVariation(playerPed, 9, 2, 1, 2)
	AddArmourToPed(playerPed, 100)
	SetPedArmour(playerPed, 100)
end)


RegisterNetEvent('esx_extraitems:bulletproof3')
AddEventHandler('esx_extraitems:bulletproof3', function()
	local playerPed = GetPlayerPed(-1)
...
RegisterNetEvent('esx_extraitems:bulletproof4')
AddEventHandler('esx_extraitems:bulletproof4', function()
	local playerPed = GetPlayerPed(-1)
	SetPedComponentVariation(playerPed, 9, 1, 1, 2)
	AddArmourToPed(playerPed, 150)
	SetPedArmour(playerPed, 150)
end)
