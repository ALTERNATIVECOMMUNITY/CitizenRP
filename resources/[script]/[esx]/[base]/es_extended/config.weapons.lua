...
Config.Weapons = {
...

	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_fbiarb')},
			{name = 'flashlight', label = 'Lampe', hash = GetHashKey('COMPONENT_AT_fbiarb_FLSH')},
		--	{name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_mk18b_SUPP')},
			{name = 'grip', label = 'Poignée', hash = GetHashKey('COMPONENT_AT_fbiarb_AFGRIP')}
					...
					components = {
						...
						{name = 'grip', label = 'Poignée', hash = GetHashKey('COMPONENT_AT_mk18b_AFGRIP')}
...

								{
									...
									tints = Config.DefaultWeaponTints,
									components = {
											{name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP_M700')},
...

	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('COMPONENT_SR25_CLIP_01')},
			{name = 'clip_extended', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_SR25_CLIP_02')},
			{name = 'clip_3', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_SR25_CLIP_02')},
			{name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'flashlight2', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_SR25_FLSH_02')},
			{name = 'flashlight3', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_SR25_FLSH_03')},
			{name = 'flashlight4', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_SR25_FLSH_04')},
			{name = 'scope', label =  '12', hash = GetHashKey('COMPONENT_SR25_SCOPE_01')},
			{name = 'scope1', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_02')},
			{name = 'scope2', label = '05', hash = GetHashKey('COMPONENT_SR25_SCOPE_03')},
			{name = 'scope3', label = '06', hash = GetHashKey('COMPONENT_SR25_SCOPE_04')},
			{name = 'scope4', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_05')},
			{name = 'scope5', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_06')},
			{name = 'scope6', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_07')},
			{name = 'scope7', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_08')},
			{name = 'scope8', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_09')},
			{name = 'scope9', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_10')},
			{name = 'scope10', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_11')},
			{name = 'scope11', label =  '04', hash = GetHashKey('COMPONENT_SR25_SCOPE_12')},
