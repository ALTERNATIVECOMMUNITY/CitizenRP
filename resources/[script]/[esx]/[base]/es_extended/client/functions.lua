...
ESX.ShowNotification = function(msg)
	...
	text = text:gsub("~s~", "<span style='color:silver'>")
	text = text:gsub("~g~", "<span style='color:green'>")
	text = text:gsub("~r~", "<span style='color:red'>")
	text = text:gsub("~w~", "<span style='color:white'>")
	text = text:gsub("~o~", "<span style='color:orange'>")
	exports['okokNotify']:Alert("CITIZEN-V", msg, 8000, 'info')
end
