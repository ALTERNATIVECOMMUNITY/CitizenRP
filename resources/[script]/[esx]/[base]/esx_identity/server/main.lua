...
if Config.EnableCommands then
	ESX.RegisterCommand('char', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.getName() then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('active_character', xPlayer.getName())}) 
		else
			--xPlayer.showNotification(_U('error_active_character'))

			TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('error_active_character') }) 
		end
	...
	ESX.RegisterCommand('chardel', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.getName() then
			if Config.UseDeferrals then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('deleted_character') }) 
				playerIdentity[xPlayer.identifier] = nil
				alreadyRegistered[xPlayer.identifier] = false
			else
				deleteIdentity(xPlayer)
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('error_delete_character') }) 
		end
