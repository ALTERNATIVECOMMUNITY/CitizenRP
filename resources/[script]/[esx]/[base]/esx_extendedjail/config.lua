...
-- Locations
Config.OutsideLocation = vector3(1847.95, 2586.26, 45.60) -- prison
Config.JailSpawnLocation = vector3(1638.07, 2542.61, 45.56)
Config.PrisonBlip = vector3(1858.0, 2606.0, 45.0)

Config.OutsideLocationPJail = vector3(432.34, -984.17, 30.71) -- outside mrpd cells
...
Config.Item = 'lockpick'
Config.Job = 'police'
Config.AdminTitle = 'admin'
Config.Mhacking = false
Config.TimeToAlarm = math.random(5000, 9000)
Config.TimeToHack = math.random(5000, 10000)
