...
Config.Shop = {
  {
    ...
    clothesdisplay = {
      [1] = {
        coord = vector3(619.94946289063,-8.2485122680664,76.628089904785),
        label = 'T Shirt 👕',
        indexes = {'tshirt_1','tshirt_2','arms','pants_1','pants_2','shoes_1','shoes_2','helmet_1','helmet_2','chain_1','chain_2','bags_1','bags_2','glasses_1','glasses_2'},
        blacklist = {},
      },
      [2] = {
