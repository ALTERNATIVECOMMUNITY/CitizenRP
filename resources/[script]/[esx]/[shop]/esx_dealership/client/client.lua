...
RegisterNetEvent('generate:Plate')
AddEventHandler('generate:Plate', function(generatedPlate)
	GeneratePlate()
end)
...
AddEventHandler('vehicleshop.spawnVehicle', function(model, plate)
    ...
    local vehicleBuy = CreateVehicle(hash, -774.52, -233.12, 37.13, 132.0, 1, 1)
...
RegisterNUICallback(
    ...
    function(data, cb)
        if Config.TestDrive then
            ...
            testDriveEntity = CreateVehicle(hash, -946.09466552734,-3346.6674804688,13.951107978821, 132.0, 1, 1)
