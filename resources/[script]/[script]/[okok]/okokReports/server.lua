...
local Webhook =
    'https://discord.com/api/webhooks/904802391235387492/Ub1GI2pzJcH64OPbi8nJzOPrT1vaqZXF2t7DIoun3H2I1o7ymHhocugxOYboCgrXgoVj'
local staffs = {}
local FeedbackTable = {}
    ...
    if staffs[source] then
        if canAssist then
            ...
            if GetPlayerPing(id) > 0 then
                ...
                TriggerClientEvent('okokNotify:Alert', source, "REPORT",
                    "vous assistez FEEDBACK #" .. feedbackId .. "!", 20000, 'info')
                ...
                TriggerClientEvent('okokNotify:Alert', id, "REPORT", "Ce joueur n'est plus sur le serveur!", 20000,
                    'error')
            end
