...
local Webhook = 'https://discord.com/api/webhooks/886270075328405524/Ui4PParkE-YnbfWfQoB4A37HTVYZ61IEIMHG8SM58GN2osTbveeVVsz-BGz23f7nYHZM'
local staffs = {}
local FeedbackTable = {}
	...
	if staffs[source] then
		if canAssist then
			...
			if GetPlayerPing(id) > 0 then
				...
				TriggerClientEvent('okokNotify:Alert', source, "REPORT", "vous assistez FEEDBACK #"..feedbackId.."!", 20000, 'info')
				...
				TriggerClientEvent('okokNotify:Alert', id, "REPORT", "Ce joueur n'est plus sur le serveur!", 20000, 'error')
			end
