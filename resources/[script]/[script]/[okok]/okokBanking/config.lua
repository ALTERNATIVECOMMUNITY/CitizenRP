...
Config.IBANChangeCost = 50 -- How much it costs to change the IBAN to a custom one (on Settings tab)

Config.PINChangeCost = 20 -- How much it costs to change the PIN (on Settings tab)
