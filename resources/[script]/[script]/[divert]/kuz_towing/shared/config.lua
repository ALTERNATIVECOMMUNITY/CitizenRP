...
Locale.press_to_attach = 'Appuyez pour attacher'
Locale.press_to_detach = 'Détachez toutes les cordes'
Locale.vehicles_locked = 'Ce véhicule est verrouillé et ne peut donc pas être remorqué'
