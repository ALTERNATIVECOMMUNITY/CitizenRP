--[[
    ...
    Smart Signs Plugin Configuration
...
local config = {
    ...
    main = {
        ...
        -- Enable this to allow on duty units to use signs (SonoranCAD Units in CAD)
        ...
        -- You must add your webhook url below
        logging = {
            enabled = false,
            ...
            webhook = "", -- Enter your Discord webhook URL here
    ...
    signs = {
        ...
        },
        {
            ...
            label = "Los Santos Freeway/Popular St",
        },
        {
        ...
        },
        {
            ...
            label = "Del Perro Fwy/La Puerta Fwy",
        },
        {
        ...
        },
        {
            ...
            label = "Palomino Ave/Bay City Ave",
        },
        {
        ...
        },
        {
            ...
            label = "Equality Way/Del Perro Fwy",
        },
        {
        ...
        },
        {
            ...
            label = "Del Perro Fwy/Popular St",
        },
        {
