...
Config = {
    ...
    T1GER_Insurance = false, -- set to false if you dont own/use insurance.

    Police = {
        Jobs = {
            'police',
            'sheriff'
        }, -- police job names in database
    ...
    Lock = {
        Key = 303, -- key to lock/unlock cars (DEFAULT: [L]), set to 0 to disable.
        Status = 10, -- select between 2 and 10 (10 nothing happens when u press enter vehicle key, with 2 u have chance of breaking windows if u unlock at the moment u press enter vehicle key)
    ...
    Keys = {
        Command = 'givekeys', -- command to give keys, set to '' to disable.
    ...
    CarMenu = {
        Key = 168, -- key to open car menu (DEFAULT: [F3]), set to 0 to disable.
        Command = 'carmenu' -- command to open car menu, set to '' to disable
    },

    Engine = {
        Key = 29, -- key to toggle engine on/off (DEFAULT: [K]), set to 0 to disable.
    ...
    Steal = {
        ...
        ShutEngineOff = false, -- shut engine off when NPC leaves car, else engine is running. (keep in player has to manu turn on engine, in case theft is successfull)
...
Config.AlarmShop = {
    pos = vector3(0, 0, 0), -- pos to open menu
    key = 38, -- key to open menu
    text = Test, -- draw text
