						...
						if not key_lock and not radio_wheel_active then
							...
							if state_lxsiren[veh] < 1 then
								if IsDisabledControlPressed(0, 80) then
									SetActivityTimer()
									actv_manu = true
									HUD:SetItemState("manu", true)
								else
									if actv_manu then
										HUD:SetItemState("manu", false)
