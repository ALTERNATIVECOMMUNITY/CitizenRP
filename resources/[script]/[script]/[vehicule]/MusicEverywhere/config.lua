...
Config.DistanceToVolume = 0.2 -- The distance that will be with the volume at 1.0, so if the volume is 0.5 the distance will be 15.0, if the volume is 0.2 the distance will be 6.
...
Config.Zones = {
	...
	},
	{
		...
		{
		name = "VillaFalcon", -- The name of the radio, it doesn't matter
		coords = vector3(-175.99,883.02,233.46), -- the position where the music is played
		job = "police", --the job that can change the music
		range = 100.0, -- the range that music can be heard
		volume = 0.8, --default volume? min 0.00, max 1.00
		deflink = "https://www.youtube.com/watch?v=GHX3lWJxQPA",-- the default link, if nill it won't play nothing
		isplaying = true, -- the music will play when the server start?
		loop = false,-- when the music stops it will repaeat?
		deftime = 0, -- where does the music starts? 0 and it will start in the beginning
		changemusicblip = vector3(-177.74,889.45,233.46) -- where the player can change the music
	},

	{
		name = "VillaReacher", -- The name of the radio, it doesn't matter
		coords = vector3(-2613.89,1892.67,164.67), -- the position where the music is played
		job = "police", --the job that can change the music
		range = 80, -- the range that music can be heard
		volume = 0.5, --default volume? min 0.00, max 1.00
		deflink = "https://www.youtube.com/watch?v=Pku7dcWl7s0",-- the default link, if nill it won't play nothing
		isplaying = true, -- the music will play when the server start?
		loop = false,-- when the music stops it will repaeat?
		deftime = 0, -- where does the music starts? 0 and it will start in the beginning
		changemusicblip = vector3(-2590.83,1882.05,167.32) -- where the player can change the music
	},
}
