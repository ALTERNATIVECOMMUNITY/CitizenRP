...
local BreakTime = 0;
local percentDecrease = 45 -- On enleve 45% de sa faim actuelle et pas 45% du total
local minPercentToTrigger = 15 -- On enleve de la faim uniquement si le joueur a plus de 15% de faim
...
AddEventHandler('esx_status:loaded', function(status)
    if Config.Status then
        TriggerEvent('esx_status:registerStatus', 'hunger', 1000000, '#CFAD0F', function(status)
            ...
            local minute = tonumber(GetClockMinutes())
            local food = math.floor(tonumber(status._get("val")))
            if hour == 12 and minute == 0 and BreakTime ~= hour or hour == 20 and minute == 0 and BreakTime ~= hour then
                BreakTime = hour
                if food > minPercentToTrigger * 1000 then
                    status.remove((percentDecrease * food) / 100)
                else
                    status.remove(100)
                end
            else
...
AddEventHandler('devcore_needs:client:StartEat', function(item, label, g, prop, hunger, p1, p2, p3, p4, p5, p6)
    if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
        ...
        AttachEntityToEntity(propfood, player, GetPedBoneIndex(player, 18905), p1, p2, p3, p4, p5, p6, true, true,
            false, true, 1, true)
        while true do
            Citizen.Wait(1)
            if FoodEat then
                ...
                if IsControlJustPressed(0, Config.ServeFood) then
                    ...
                    if closestPlayer ~= -1 and closestDistance <= 1.5 then
                        ...
                        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                            ...
                            local player = GetPlayerServerId(data.current.player)
                            TriggerServerEvent('devcore_needs:server:RemoveItem', item)
                            TriggerServerEvent('devcore_needs:server:ReceiverFood', GetPlayerServerId(PlayerId()),
                                player, item, label, g, prop, hunger, p1, p2, p3, p4, p5, p6)
                            menu.close()
                            FoodEat = false
                            ClearPedTasks(player)
                            DetachEntity(propfood, 1, 1)
...
AddEventHandler('devcore_needs:client:StartDrink',
    function(item, item2, ml, propd, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
        if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
            exports['mythic_notify']:DoHudText('error', _U('already'))
        else
            if split then
                TriggerEvent('devcore_needs:client:StartSplitDrink', item, item2, ml, propd, alcohol, split,
                    drinkstatus, p1, p2, p3, p4, p5, p6)
            else
                Drink = true
                ...
                AttachEntityToEntity(propdrink, player, GetPedBoneIndex(player, 28422), p1, p2, p3, p4, p5, p6, true,
                        ...
                        if IsControlJustPressed(0, Config.ServeDrink) then
                            ...
                            if closestPlayer ~= -1 and closestDistance <= 1.5 then
                                ...
                                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                                    ...
                                    local player = GetPlayerServerId(data.current.player)
                                    TriggerServerEvent('devcore_needs:server:RemoveItem', item)
                                    TriggerServerEvent('devcore_needs:server:ReceiverDrink',
                                        GetPlayerServerId(PlayerId()), player, item, item2, ml, propdrink, alcohol,
                                        split, drinkstatus, p1, p2, p3, p4, p5, p6)
                                    menu.close()
                                    Drink = false
...
AddEventHandler('devcore_needs:client:StartReceiverDrink',
    function(item, item2, ml, propdrink, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
        if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
            exports['mythic_notify']:DoHudText('error', _U('already'))
        else
            if split then
                TriggerEvent('devcore_needs:client:StartSplitDrink', item, item2, ml, propdrink, alcohol, split,
                    drinkstatus, p1, p2, p3, p4, p5, p6)
            else
                TriggerServerEvent('devcore_needs:server:AddItem', item)
                Drink = true
                        ...
                        if IsControlJustPressed(0, Config.ServeDrink) then
                            ...
                            if closestPlayer ~= -1 and closestDistance <= 1.5 then
                                ...
                                ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                                    ...
                                    TriggerServerEvent('devcore_needs:server:RemoveItem', item)
                                    TriggerServerEvent('devcore_needs:server:ReceiverDrink',
                                        GetPlayerServerId(PlayerId()), player, item, item2, ml, propd, alcohol, split,
                                        drinkstatus, p1, p2, p3, p4, p5, p6)
                                    menu.close()
                                    DetachEntity(propdrink, 1, 1)
                                    DeleteObject(propdrink)
...
AddEventHandler('devcore_needs:client:StartSplitDrink',
    function(item, item2, ml, propd, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
        if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
            exports['mythic_notify']:DoHudText('error', _U('already'))
        else
            ...
            local x, y, z = table.unpack(GetEntityCoords(player))
            propdrink = CreateObject(GetHashKey(propd), x, y, z + 0.2, true, true, true)
            AttachEntityToEntity(propdrink, player, GetPedBoneIndex(player, 28422), p1, p2, p3, p4, p5, p6, true, true,
                false, true, 1, true)
            while true do
                Citizen.Wait(1)
                if SplitDrink then
                    ...
                    if IsControlJustPressed(0, Config.SplitDrinkButton) then
                        if ml > 29 then
                            ...
                            TriggerEvent('devcore_needs:client:ShotDrinkSplit', item, item2, ml, propdrink, alcohol,
                                split, drinkstatus, p1, p2, p3, p4, p5, p6)
                        else
                        ...
                        if closestPlayer ~= -1 and closestDistance <= 1.5 then
                            ...
                            ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                                ...
                                TriggerServerEvent('devcore_needs:server:ReceiverDrink', GetPlayerServerId(PlayerId()),
                                    player, item, item2, ml, propdrink, alcohol, split, drinkstatus, p1, p2, p3, p4, p5,
                                    p6)
                                menu.close()
                                SplitDrink = false
                                ClearPedTasks(playerPed)
...
AddEventHandler('devcore_needs:client:ShotDrinkSplit',
    function(item, item2, ml, propdrink, alcohol, split, drinkstatus, p1, p2, p3, p4, p5, p6)
        if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
            exports['mythic_notify']:DoHudText('error', _U('already'))
        else
            ...
            AttachEntityToEntity(propdrink, player, GetPedBoneIndex(player, 28422), 0.13, -0.05, -0.16, -70.0, 50.0,
                60.0, true, true, false, true, 1, true)
            AttachEntityToEntity(propsplitdrink, player, GetPedBoneIndex(player, 18905), 0.11, 0.03, 0.02, 250.0, 0.0,
                0.0, true, true, false, true, 1, true)
            while true do
                Citizen.Wait(1)
                if DrinkShot then
                    if not IsPedInAnyVehicle(player, true) and IsEntityPlayingAnim(player, ad, "ped_a_enter_loop", 3) ~=
                        1 then
                    ...
                    if IsControlJustPressed(0, Config.DrinkingButton) then
                        if multiplier > maxhighdone then
                            ...
                            AttachEntityToEntity(propdrink, player, GetPedBoneIndex(player, 28422), p1, p2, p3, p4, p5,
                                p6, true, true, false, true, 1, true)
                            if Config.Status then
                                TriggerServerEvent('devcore_needs:client:UpdateStatus', 'thirst', drinkstatus)
                            end
                            if alcohol > 0.0259949 then
                            ...
                            if mlshot < 10 then
                                ...
                                DrinkShot = false
                                SplitDrink = true
                                AttachEntityToEntity(propdrink, player, GetPedBoneIndex(player, 28422), p1, p2, p3, p4,
                                    p5, p6, true, true, false, true, 1, true)
                                break
                            end
                        end
                    elseif IsControlJustPressed(0, Config.DrinkThrowButton) then
                        ...
                        DrinkShot = false
                        SplitDrink = true
                        AttachEntityToEntity(propdrink, player, GetPedBoneIndex(player, 28422), p1, p2, p3, p4, p5, p6,
                    ...
                    elseif IsControlJustPressed(0, Config.ServeDrink) then
                        ...
                        if closestPlayer ~= -1 and closestDistance <= 1.5 then
                            ...
                            ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                                ...
                                local player = GetPlayerServerId(data.current.player)
                                TriggerServerEvent('devcore_needs:server:ReceiverDrinkShot',
                                    GetPlayerServerId(PlayerId()), player, item, item2, mlshot, alcohol, drinkstatus)
...
AddEventHandler('devcore_needs:client:ReceiverDrinkShot', function(item, item2, mlshot, alcohol, drinkstatus)
    if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
        ...
        local x, y, z = table.unpack(GetEntityCoords(player))
        propsplitdrink = CreateObject(GetHashKey('p_cs_shot_glass_s'), x, y, z + 0.2, true, true, true)
        AttachEntityToEntity(propsplitdrink, player, GetPedBoneIndex(player, 18905), 0.11, 0.03, 0.02, 250.0, 0.0, 0.0,
            true, true, false, true, 1, true)
        while true do
            Citizen.Wait(1)
            if DrinkShot then
                    ...
                    if closestPlayer ~= -1 and closestDistance <= 1.5 then
                        ...
                        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                            ...
                            TriggerServerEvent('devcore_needs:server:ReceiverDrinkShot', GetPlayerServerId(PlayerId()),
                                player, item2, label, mlshot, alcohol, drinkstatus)
                ...
                elseif IsControlJustPressed(0, Config.ServeDrink) then
                    ...
                    if closestPlayer ~= -1 and closestDistance <= 1.5 then
                        ...
                        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                            ...
                            local player = GetPlayerServerId(data.current.player)
                            TriggerServerEvent('devcore_needs:server:ReceiverDrinkShot', GetPlayerServerId(PlayerId()),
                                player, item, label, mlshot, alcohol, drinkstatus)
                            menu.close()
                            DrinkShot = false
                            ClearPedTasks(playerPed)
                            DetachEntity(propsplitdrink, 1, 1)
...
AddEventHandler('devcore_needs:client:StartDrinkWine',
    function(item, item2, ml, propw, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
        if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
            exports['mythic_notify']:DoHudText('error', _U('already'))
        else
            DrinkWine = true
            ...
            AttachEntityToEntity(propwine, player, GetPedBoneIndex(player, 28422), p1, p2, p3, p4, p5, p6, true, true,
                false, true, 1, true)
            while true do
                Citizen.Wait(1)
                if DrinkWine then
                    ...
                    if IsControlJustPressed(0, Config.SplitDrinkButton) then
                        if ml > 99 then
                            ...
                            TriggerEvent('devcore_needs:client:WineDrinkGlass', item, item2, propw, ml, alcohol,
                                drinkstatus, p1, p2, p3, p4, p5, p6)
                        else
                            exports['mythic_notify']:DoHudText('error', _U('alreadybottle'))
                        end
                    ...
                    if IsControlJustPressed(0, Config.ServeDrink) then
                        ...
                        if closestPlayer ~= -1 and closestDistance <= 1.5 then
                            ...
                            ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                                ...
                                local player = GetPlayerServerId(data.current.player)
                                TriggerServerEvent('devcore_needs:server:RemoveItem', item)
                                TriggerServerEvent('devcore_needs:server:ReceiverDrinkSplitWine',
                                    GetPlayerServerId(PlayerId()), player, item, item2, ml, propw, alcohol, drinkstatus,
                                    p1, p2, p3, p4, p5, p6)
                                menu.close()
                                DrinkWine = false
                                ClearPedTasks(playerPed)
...
AddEventHandler('devcore_needs:client:ReceiverDrinkSplitWine',
    function(item, item2, ml, propw, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
        if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
            exports['mythic_notify']:DoHudText('error', _U('already'))
        else
...
AddEventHandler('devcore_needs:client:ReceiverDrinkGlass',
    function(item, label, mlwine, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
        if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
            exports['mythic_notify']:DoHudText('error', _U('already'))
        else
            ...
            AttachEntityToEntity(propwineglass, player, GetPedBoneIndex(player, 18905), 0.11, -0.03, 0.03, 250.0, 0.0,
                0.0, true, true, false, true, 1, true)
            while true do
                Citizen.Wait(1)
                if DrinkGlass then
                    ...
                    elseif IsControlJustPressed(0, Config.ServeDrink) then
                        ...
                        if closestPlayer ~= -1 and closestDistance <= 1.5 then
                            ...
                            ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                                ...
                                local player = GetPlayerServerId(data.current.player)
                                TriggerServerEvent('devcore_needs:server:ReceiverDrinkGlass',
                                    GetPlayerServerId(PlayerId()), player, item, label, mlwine, alcohol, drinkstatus,
                                    p1, p2, p3, p4, p5, p6)
                                menu.close()
                                DrinkGlass = false
                                DetachEntity(propwineglass, 1, 1)
...
AddEventHandler('devcore_needs:client:WineDrinkGlass',
    function(item, item2, propw, ml, alcohol, drinkstatus, p1, p2, p3, p4, p5, p6)
        if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
            exports['mythic_notify']:DoHudText('error', _U('already'))
        else
            mlwine = 100
            ...
            local x, y, z = table.unpack(GetEntityCoords(player))
            propwineglass = CreateObject(GetHashKey('p_wine_glass_s'), x, y, z + 0.2, true, true, true)
            AttachEntityToEntity(propw, player, GetPedBoneIndex(player, 28422), 0.13, -0.05, -0.16, -70.0, 50.0, 60.0,
                true, true, false, true, 1, true)
            AttachEntityToEntity(propwineglass, player, GetPedBoneIndex(player, 18905), 0.11, -0.03, 0.03, 250.0, 0.0,
                0.0, true, true, false, true, 1, true)
            while true do
                ...
                if DrinkGlass then
                    ...
                    if IsControlJustPressed(0, Config.DrinkingButton) then
                        if multiplier > maxhighdone then
                            ...
                            if mlwine < 10 then
                                ...
                                DrinkGlass = false
                                DrinkWine = true
                                AttachEntityToEntity(propw, player, GetPedBoneIndex(player, 28422), p1, p2, p3, p4, p5,
                                    p6, true, true, false, true, 1, true)
                                break
                            end
                        end
                    elseif IsControlJustPressed(0, Config.DrinkThrowButton) then
                        ...
                        DrinkGlass = false
                        DrinkWine = true
                        AttachEntityToEntity(propw, player, GetPedBoneIndex(player, 28422), p1, p2, p3, p4, p5, p6,
                            true, true, false, true, 1, true)
                        break
                    elseif IsControlJustPressed(0, Config.CleanUpItem) then
                        if mlwine < 99 then
                    ...
                    elseif IsControlJustPressed(0, Config.ServeDrink) then
                        ...
                        if closestPlayer ~= -1 and closestDistance <= 1.5 then
                            ...
                            ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                                ...
                                local player = GetPlayerServerId(data.current.player)
                                TriggerServerEvent('devcore_needs:server:ReceiverDrinkGlass',
                                    GetPlayerServerId(PlayerId()), player, item, item2, mlwine, alcohol, drinkstatus,
                                    p1, p2, p3, p4, p5, p6)
                                DrinkGlass = false
                                menu.close()
                                ClearPedTasks(playerPed)
...
AddEventHandler('devcore_needs:client:WineGlass', function(item, label, mlwine, alcohol, drinkstatus)
    if Drink or FoodEat or DrinkShot or SplitDrink or DrinkWine or DrinkGlass then
        ...
        local x, y, z = table.unpack(GetEntityCoords(player))
        propwineglass = CreateObject(GetHashKey('p_wine_glass_s'), x, y, z + 0.2, true, true, true)
        AttachEntityToEntity(propwineglass, player, GetPedBoneIndex(player, 18905), 0.11, -0.03, 0.03, 250.0, 0.0, 0.0,
            true, true, false, true, 1, true)
        while true do
            Citizen.Wait(1)
            if DrinkGlass then
                    ...
                    if closestPlayer ~= -1 and closestDistance <= 1.5 then
                        ...
                        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reciver_menu', {
                            ...
                            TriggerServerEvent('devcore_needs:server:ReceiverDrinkGlass', GetPlayerServerId(PlayerId()),
                                player, item, label, mlwine, alcohol, drinkstatus)
                            menu.close()
                            DrinkGlass = false
                            ClearPedTasks(playerPed)
                            DetachEntity(propwineglass, 1, 1)
