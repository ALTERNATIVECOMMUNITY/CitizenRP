...
--Main
Config.Locale = 'en'
Config.ItemTester = 'breathalyser' -- Item for alcohol tester
...
Config.Drink = {
   ...
   -- thirst is added after each click of the Drink button -- Alcohol = How much effect is added after one click on the Drink button -- Shots = true if you want to pour shots from the bottle -- pos = prop position
    ...
    {Item = "coffee",  CleanUpItem = '', ml = 500, Prop = "p_ing_coffeecup_01", StatusDrink = 10000, Alcohol = 0.0, Shots = false, Pos1 = 0.0, Pos2 = -0.01, Pos3 = -0.02, Pos4 = 05.0, Pos5 = -10.0, Pos6 = 0.0},

    {Item = "water",  CleanUpItem = '', ml = 500, Prop = "prop_ld_flow_bottle", StatusDrink = 100000, Alcohol = 0.0, Shots = false, Pos1 = 0.0, Pos2 = -0.01, Pos3 = -0.02, Pos4 = 05.0, Pos5 = -10.0, Pos6 = 0.0},
