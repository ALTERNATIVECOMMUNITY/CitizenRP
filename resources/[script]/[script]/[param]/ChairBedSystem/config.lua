...
Config.objects = {
	...
	locations = {
		...
		[9] = {object="v_med_emptybed", verticalOffsetX=0.0, verticalOffsetY=0.0, verticalOffsetZ=-1.15, direction=0.0, bed=true},
		[10] = {object="Prop_Off_Chair_01", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		[11] = {object="prop_cs_office_chair", verticalOffsetX=0.0, verticalOffsetY=0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		[12] = {object="ba_prop_battle_club_chair_01", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=0.1, direction=180.0, bed=false},
		[13] = {object="v_res_m_dinechair", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=0.1, direction=180.0, bed=false},
			[14] = {object="Prop_Rock_Chair_01", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=0.1, direction=180.0, bed=false},
				[15] = {object="ex_mp_h_din_chair_04", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
				...
				[17] = {object="v_ret_chair_white", verticalOffsetX=0.0, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
					[18] = {object="xm_prop_x17_avengerchair_02", verticalOffsetX=0.0, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
