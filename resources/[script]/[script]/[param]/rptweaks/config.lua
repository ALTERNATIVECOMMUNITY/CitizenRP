...
Config.KeepEngineOn = false -- keep engine on if player dont turn it off when exiting vehicle.

Config.NoHeadshots = false -- prevents 1 shot headshot kill players.
...
Config.SameHealthForMaleAndFemalesPeds = false -- sets both male and female health to 200 (100 in game).
