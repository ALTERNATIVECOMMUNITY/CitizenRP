...
-- Analytics and leak prevention...
function sendHeartbeat()
	Citizen.CreateThread(function()
		PerformHttpRequest("http://api.veryinsanee.space/api/v1/heartbeat/", function (p1, p2, p3) end, 'POST', json.encode({resourceName = GetCurrentResourceName(), activePlayers = GetNumPlayerIndices() }), { ['Content-Type'] = 'application/json' })
