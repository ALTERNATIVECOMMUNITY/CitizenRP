...
TokoVoipConfig = {
	...
	wsServer = "141.94.96.205:33250", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSServer = "141.94.96.205", -- TeamSpeak server address to be displayed on blocking screen
		...
		localName = "",--"GetPlayerName(PlayerId())", -- If set, this name will be used as the user's teamspeak display name
