    ...
    if type(data) == "table" then
        ...
        if twtAcc ~= nil then
          ...
          TwitterLikes[data.id] = {}
                ...
                HSN.SendLog("Twitter", "https://discord.com/api/webhooks/887342449394090065/JEP3G8buNSHjH1e8FwJYb4R_qpz9djzEOPqZgj4jqyXQTp0udGRaeXGr1M73vDrO4eM4", data.message, data.photo, data.user_photo)
            end)
        end
    end
end)
