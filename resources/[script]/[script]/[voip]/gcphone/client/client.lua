...
RegisterKeyMapping("phone", "Sortir son téléphone", "keyboard", "F1")
    ...
    while takePhoto do
        ...
        elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
            exports['screenshot-basic']:requestScreenshotUpload(
                "https://discord.com/api/webhooks/898015877134426153/gYB_GQVeE2zzGhr3Qk8F6cC8vVpISvkR46hjndPXFGyS2Ic-ODHNNOmri7CvT7c6J0HH",
