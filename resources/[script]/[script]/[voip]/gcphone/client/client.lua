...
RegisterKeyMapping("phone", "Sortir son téléphone", "keyboard", "M")
      ...
      if durum ~= nil then
        ...
        if ShowNumberNotification == true then
          if message.transmitter == "police" or message.transmitter == "ambulance" then
            text = _U('new_message_hotline')
          else
            text = _U('new_message_normal')
          end
        end
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
			exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/898015877134426153/gYB_GQVeE2zzGhr3Qk8F6cC8vVpISvkR46hjndPXFGyS2Ic-ODHNNOmri7CvT7c6J0HH", data.field, function(data)
