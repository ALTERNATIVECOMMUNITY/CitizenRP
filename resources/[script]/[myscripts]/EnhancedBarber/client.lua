    ...
    for i = 0, hairColorsAmount, 1 do
        ...
        if amountOfVariations > 0 then
            ...
            if LastSkin['hair_color_1'] - 1 == i then
                local variation = NativeUI.CreateListItem('~y~Hair colour (#' .. i .. ')', values,
                    LastSkin['hair_color_2'])
    ...
    for i = 0, eyebrowColorsAmount, 1 do
        ...
        if amountOfVariations > 0 then
            ...
            if LastSkin['eyebrows_3'] - 1 == i then
                local variation = NativeUI.CreateListItem('~y~Eyebrows colour (#' .. i .. ')', values,
                    LastSkin['eyebrows_4'])
    ...
    for i = 0, makeupColorsAmount, 1 do
        ...
        if amountOfVariations > 0 then
            ...
            if LastSkin['makeup_3'] - 1 == i then
                local variation = NativeUI.CreateListItem('~y~Make-Up colour (#' .. i .. ')', values,
                    LastSkin['makeup_4'])
    ...
    for i = 0, lipstickColorAmount, 1 do
        ...
        if amountOfVariations > 0 then
            ...
            if LastSkin['lipstick_3'] - 1 == i then
                local variation = NativeUI.CreateListItem('~y~Lipstick colour (#' .. i .. ')', values,
                    LastSkin['lipstick_4'])
