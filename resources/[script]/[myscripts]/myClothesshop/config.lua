...
Config.Shops = { 
    ...
    {type = 'shopui_title_highendfashion', x = 200.922, y = -871.115, z = 30.713, rot = 150.01162719727},
    ...
    {type = 'BLACKLIST', x = 986.4339599609, y = -92.4339599609, z = 74.8039599609, rot = 99.7255859375},
    {type = 'BLACKLIST', x = -2592.11, y = 1921.36, z = 163.74, rot = 99.7255859375},
     {type = 'BLACKLIST', x = -165.52, y = 918.75, z = 239.95, rot = 99.7255859375},
      {type = 'BLACKLIST', x = -2797.86, y = 1434.91, z = 97.32, rot = 99.7255859375},
      {type = 'BLACKLIST', x = -743.97, y = 504.07, z = 109.57, rot = 99.7255859375},
...
Config.shopContent = { -- normal shop
  ...
  blockedParts = {
  [0] = {1,4,5,2,55,73,74,75,77,80,81,92,93,94,95,101,102,108,110,159,160},
  [1] = {1,4,5,2,55,73,74,75,77,80,81,92,93,94,95,101,102,108,110,159,160}}}, -- 0 = male; 1 = female
  {componentID = 8, name = 'tshirt_1', name2 = 'tshirt_2', label = 'T-Shirts', zoomOffset = 0.75, camOffset = 0.15, type = 1, 
  blockedParts = {
  [0] = {--[[58,65,66,68,97,105,122--]]},
  [1] = {}}}, -- 0 = male; 1 = female
  {componentID = 3, name = 'arms', name2 = nil, label = 'Bras', zoomOffset = 0.75, camOffset = 0.15, type = 1, 
  blockedParts = {
  [0] = {},
  [1] = {}}}, -- 0 = male; 1 = female
  {componentID = 4, name = 'pants_1', name2 = 'pants_2', label = 'Pantalons', zoomOffset = 0.8, camOffset = -0.5, type = 1, 
  blockedParts = {
  [0] = {},
  [1] = {}}}, -- 0 = male; 1 = female
  {componentID = 6, name = 'shoes_1', name2 = 'shoes_2', label = 'Chaussures', zoomOffset = 0.8, camOffset = -0.8, type = 1, 
  blockedParts = {
  [0] = {},
  [1] = {}}}, -- 0 = male; 1 = female
  {componentID = 7, name = 'chain_1', name2 = 'chain_2', label = 'Chaine / Accessoires', zoomOffset = 1.0, camOffset = 0.45, type = 1, 
  blockedParts = {
  [0] = {1,2,3,8,125,126,128},
  [1] = {}}}, -- 0 = male; 1 = female
  {componentID = 1, name = 'glasses_1', name2 = 'glasses_2', label = 'Lunettes', zoomOffset = 0.6, camOffset = 0.65, type = 2, 
  blockedParts = {
  [0] = {},
  [1] = {}}}, -- 0 = male; 1 = female
  {componentID = 2, name = 'ears_1', name2 = 'ears_2', label = 'Accessoires Oreilles', zoomOffset = 0.4, camOffset = 0.65, type = 2, 
  blockedParts = {
  [0] = {},
  [1] = {}}}, -- 0 = male; 1 = female
  ...
  blockedParts = {
  [0] = {},
  [1] = {33,59,66,74}}}, -- 0 = male; 1 = female
  {componentID = 0, name = 'helmet_1', name2 = 'helmet_2', label = 'Helmet', zoomOffset = 0.6, camOffset = 0.65, type = 2, 
  blockedParts = {
  [0] = {--[[2,83,84,122,111,115,116,117,118,119,122,124,125,126,31,32,35,36--]]},
  [1] = {--[[2,83,84,122,111,115,116,117,118,119,122,124,125,126,31,32,35,36--]]}}}, -- 0 = male; 1 = female
...
Config.HATersContent = { -- accessoires shop
  {componentID = 5, name = 'bags_1', name2 = 'bags_2', label = 'Sac', zoomOffset = 0.75, camOffset = 0.15, type = 1, 
  blockedParts = {
  [0] = {1},
  [1] = {1}}}, -- 0 = male; 1 = female
  {componentID = 0, name = 'helmet_1', name2 = 'helmet_2', label = 'Casque', zoomOffset = 0.6, camOffset = 0.65, type = 2, 
  blockedParts = {
  [0] = {1},
  [1] = {}}}, -- 0 = male; 1 = female
  {componentID = 6, name = 'watch_1', name2 = 'watch_2', label = 'Montre', zoomOffset = 0.8, camOffset = 0.1, type = 2},

}

Config.MaskContent = {
  {componentID = 1, name = 'mask_1', name2 = 'mask_2', label = 'Masque', zoomOffset = 0.6, camOffset = 0.65, type = 1, 
  blockedParts = {
  [0] = {},
  [1] = {}}}, -- 0 = male; 1 = female
}
...
Translation = {
  ...
  ['en'] = {
    ['press_e_interact'] = 'Appuis sur ~g~E~s~, pour changer de vetements',
    ['blip_normal'] = 'Magasin de vetements',
    ['blip_haters'] = 'HATers shop',
    ['blip_mask'] = 'Vespucci masks',
    ['menu_buy_clothes'] = 'Acheter vetements?',
    ['menu_confirm'] = 'Confirmer ',
    ['menu_abort'] = 'Annuler',
    ['title_haters'] = 'Accessoires ',
    ['change_colour'] = '~s~Changer de variation',
    ['saved'] = '~g~Tenues ~w~',
    ['saved_2'] = '~g~ à été sauvegarder.',
    ['not_enough_money'] = '~r~Tu n\'as pas assez d\'argent.',
    ['buy_complete'] = '~y~Vendeur~s~: Merci pour vos achats, hâte de vous revoir !.',
    ['outfin_use'] = 'Mettre tenue',
    ['outfit_remove'] = 'Suprimer tenue',
    ['outfit_removed'] = 'Tenue :  ~y~',
    ['outfit_removed2'] = ' ~s~supprimé.',
    ['saved_outfits'] = 'Tenue sauvegardé',
  }
}
