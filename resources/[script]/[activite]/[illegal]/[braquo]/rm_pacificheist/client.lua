...
AddEventHandler('pacificheist:client:policeAlert', function(targetCoords)
    ...
    exports['core_dispach']:addMessage('Braquage Pacific Banque', {targetCoords.x, targetCoords.y, targetCoords.z}, 'police', 5000, 11, 5)
      exports['core_dispach']:addMessage('Braquage Pacific Banque', {targetCoords.x, targetCoords.y, targetCoords.z}, 'sheriff', 5000, 11, 5)
...
function StartHeist()
  ...
  ESX.TriggerServerCallback('banque:itempourstart', function(qtty)
    if qtty > 0 then
    ...
    exports['okokNotify']:Alert("Citizen-V", "Vous n'avez pas ce qu'il vous faut (Perceuse, Panneau de hack, Ordinateur portable, Thermite, C4.)", 25000, 'error')
  end
end,"thermite_bomb")
end
