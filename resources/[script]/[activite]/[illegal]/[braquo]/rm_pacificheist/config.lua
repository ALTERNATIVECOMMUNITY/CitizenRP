...
Config['PacificHeist'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names. Also dont forget glass cutting and painting item names.(in bottom)
        {itemName = 'gold', sellPrice = 100},
        {itemName = 'diamond', sellPrice = 100},
        {itemName = 'coke_pooch', sellPrice = 100},
    },
    ...
    ['startHeist'] ={ -- heist start coords
        pos = vector3(258.49877929688,219.13983154297,106.28637695313),
        peds = {
            {pos = vector3(-622.70, 328.733, -8005.2510), heading = 315.22, ped = 's_m_m_highsec_01'},
            {pos = vector3(-621.71, 328.410, -8005.2510), heading = 23.78, ped = 's_m_m_highsec_02'},
            {pos = vector3(-622.89, 329.701, -8005.2510), heading = 228.42, ped = 's_m_m_fiboffice_02'}
        }
    },
    ['finishHeist'] = {
...
Strings = {
    ['e_start'] = 'Appuyez sur ~INPUT_CONTEXT~ pour démarrer braquage Pacific Heist',
    ['start_heist'] = 'Faite péter la porte',
    ['start_heist2'] = 'Choses requises pour le vol: Ordinateur portable, Panneau de hack, Cutter, C4, Perceuse ',
    ['plant'] = 'Appuyez sur ~INPUT_CONTEXT~ pour planter de la thermite',
    ['plant_bomb'] = 'Appuyez sur ~INPUT_CONTEXT~ pour planter C4',
    ['detonate_bombs'] = 'Appuyez sur ~INPUT_CONTEXT~ pour faire exploser des bombes',
    ['grab'] = 'Appuyez sur ~INPUT_CONTEXT~ pour saisir',
    ['hacking'] = 'Appuyez sur ~INPUT_CONTEXT~ pour utiliser hack usb',
    ['vault'] = 'Appuyez sur ~INPUT_CONTEXT~ pour ouvrir le coffre-fort',
    ['drill'] = 'Appuyez sur ~INPUT_CONTEXT~ pour utiliser perceuse',
    ['wait_nextrob'] = 'Vous devez attendre aussi longtemps pour vous déshabiller à nouveau',
    ['minute'] = 'minute.',
    ['start_stealing'] = 'Appuyez sur ~INPUT_CONTEXT ~ pour voler',
    ['cute_right'] = 'Appuyez sur ~INPUT_CONTEXT~ pour couper à droite',
    ['cute_left'] = 'Appuyez sur ~INPUT_CONTEXT~ pour couper à gauche',
    ['cute_down'] = 'Appuyez sur ~INPUT_CONTEXT~ pour couper down',
    ['glass_cut'] = 'Appuyez sur ~INPUT_CONTEXT~ pour couper le verre',
    ['need_switchblade'] = 'Vous avez besoin d\'un cran d\'arrêt.',
    ['need_this'] = 'Tu as besoin de ça: ',
    ['deliver_to_buyer'] = '.',
    ['buyer_blip'] = '',
    ['need_police'] = 'Pas assez de police dans la ville.',
    ['total_money'] = 'Tu as ça: ',
    ['police_alert'] = 'Alerte au vol de la Pacific Bank! Vérifiez votre gps.',
}
