...
AddEventHandler('fleecaheist:client:policeAlert', function(targetCoords)
    ...
    exports['core_dispach']:addMessage('Braquage en cours', {targetCoords.x, targetCoords.y, targetCoords.z}, 'police', 5000, 11, 5)
      exports['core_dispach']:addMessage('Braquage en cours', {targetCoords.x, targetCoords.y, targetCoords.z}, 'sheriff', 5000, 11, 5)
    while alpha ~= 0 do
        Citizen.Wait(500)
        alpha = alpha - 1
        SetBlipAlpha(nappingBlip, alpha)
