...
Config.PayoutForFirstOrder = 800
Config.PayoutForSecondOrder = 300
Config.PayoutForThirdOrder = 1400
Config.PayoutForFourthOrder = 600
Config.PayoutForFifthOrder = 2500
...
Config.illegalorders = {
	['BossSpawn'] = { --the place where you start and finish your work
		Pos = {x = 948.43481445312, y = -208.82557678223, z = 72.308381652832, h = 0.28},
