cfg = {
    position = 'top-center', --Changes the position of the notifications
	...
	animations = {
		insertAnimation = 'insert-top', --Possible animation types: 'insert-left', 'insert-right', 'insert-top', 'insert-bottom', 'fadein', 'scalein' and 'rotatein'
