...
Citizen.CreateThread(function()
    ...
    RMenu.Add('inventory', 'weapon',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Inventaire", "~g~Inventaire du joueur"))
    RMenu.Add('inventory', 'admin', RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Admin", "Admin"))
    RMenu.Add('inventory', 'inventaire',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Inventaire", "~g~Inventaire du joueur"))
    RMenu.Add('inventory', 'inventaire_use',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Inventaire", "~g~Inventaire du joueur"))
    RMenu.Add('inventory', 'weapon_use',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Inventaire", "~g~Inventaire du joueur"))
    RMenu.Add('inventory', 'portefeuille',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Portefeuille", "~g~Portefeuille"))
    RMenu.Add('inventory', 'portefeuille_use',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Portefeuille", "~g~Portefeuille"))
    RMenu.Add('inventory', 'portefeuille_money',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Portefeuille", "~g~Actions sur votre portefeuille"))
    RMenu.Add('inventory', 'portefeuille_work',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Emplois", "~g~Gestions de votre emplois"))
    RMenu.Add('inventory', 'portefeuille_billing',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Factures", "~g~Gestions de vos factures"))
    RMenu.Add('inventory', 'menu',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Menu", "~g~Modifier la couleur de votre menu"))
    RMenu.Add('inventory', 'sante',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Santé", "~g~Infos disponibles"))
    ...
    RMenu.Add('inventory', 'clothesbase',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Tenue", "Vêtements / Accessoire"))
    RMenu.Add('inventory', 'clothes', RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Vêtements", "Vêtements"))
    RMenu.Add('inventory', 'accessories',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Accessoire", "Accessoire"))
    RMenu.Add('inventory', 'tserv', RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Touche Serveur", "~r~Serveur"))
    RMenu.Add('inventory', 'boos',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Gestion d'entreprise", "~r~Gestion d'entreprise"))
    RMenu.Add('inventory', 'voiture',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Gestion Véhicule", "~r~Gestions Véhicule"))
    RMenu.Add('inventory', 'voiture',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Gestion Véhicule", "~r~Clés"))
    ...
    RMenu.Add('inventory', 'voiture_porte',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "Véhicule", "~g~Porte de votre véhicule"))
    RMenu.Add('inventory', 'hudveh',
        RageUI.CreateSubMenu(RMenu:Get('inventory', 'main'), "HUD Véhicules", "~g~Theme HUD Voiture"))
...
RegisterKeyMapping("ragdoll", "S'écrouler / Se relever", "keyboard", "PAGEDOWN")
...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
    if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job.name ==
        society then
        societymoney = ESX.Math.GroupDigits(money)
    end
end)
        ...
        Citizen.CreateThread(function()
            while VM.Menu do
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'main'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("👛 ~g~Portefeuille", nil, {
                        RightLabel = "~y~→"
                    ...
                    RageUI.ButtonWithStyle("🎒 ~g~Mon sac à dos", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("🩸 ~r~Mon corps", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("💪 ~y~Mes compétences", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("👕 ~p~Vétements", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("🚘 ~y~Liés au véhicule", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("🔷 ~w~Divers", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                        end
                    ...
                    RageUI.ButtonWithStyle("🔫 ~w~Arme", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("⚙️ ~o~Serveur", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                        end
                    ...
                    if playerGroup ~= 'user' then
                        RageUI.ButtonWithStyle("Administration", "Menu d'Administration", {
                            RightLabel = "→"
                        }, true, function(Hovered, Active, Selected)
                ...
                RageUI.IsVisible(RMenu:Get('police', 'police'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("🔷 ~w~Controle Routier", nil, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'fringues'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Lunettes", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Chapeau", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                            ExecuteCommand('hat')
                    ...
                    RageUI.ButtonWithStyle("Veste", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Chemise", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Pantalon", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Chaussures", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("ParBalle", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Sac", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Masque", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Cou", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                            ExecuteCommand('cou')
                    ...
                    RageUI.ButtonWithStyle("Gants", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'tuture'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("🚘 ~y~Se rendre au Postal", "Menu de votre véhicule", {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    --     end
                    --   end)
                    RageUI.ButtonWithStyle("🚘 ~y~Mes Clés", "Menu de votre véhicule", {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                            ExecuteCommand("keys")
                    ...
                    RageUI.ButtonWithStyle("🚘 ~r~Crocheter", "Crocheter véhicule", {
                        RightLabel = "~r~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("🚘 ~r~Forcer Démarage", "Cabler un véhicule", {
                        RightLabel = "~r~→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'voiture'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("~g~Allumer~s~/~r~Eteindre~s~ votre moteur", nil, {
                    ...
                    RageUI.ButtonWithStyle("Gestion des portes", nil, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                        end
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'voiture_porte'), true, true, true, function()
                    RageUI.ButtonWithStyle("Ouvrir/Fermer Avant ~r~Gauche", nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Ouvrir/Fermer Avant ~g~Droite", nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Ouvrir/Fermer Ariére ~r~Gauche", nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Ouvrir/Fermer Ariére ~g~Droite", nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                    ...
                    RageUI.ButtonWithStyle("Ouvrir/Fermer ~g~Capot", nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'inventory'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Items", "Accédez à la partit item de votre inventaire", {
                        RightLabel = "→"
                    }, true, function(Hovered, Actice, Selected)
                        if (Selected) then
                        end
                    end, RMenu:Get('inventory', 'inventaire'))

                    RageUI.ButtonWithStyle("Armes", "Accédez à la partit arme de votre inventaire", {
                        RightLabel = "→"
                    }, true, function(Hovered, Actice, Selected)
                        if (Selected) then
                        end
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'inventaire'), true, true, true, function()
                    ...
                    for i = 1, #ESX.PlayerData.inventory do
                        if ESX.PlayerData.inventory[i].count > 0 then
                            RageUI.ButtonWithStyle('[~r~' .. ESX.PlayerData.inventory[i].count .. '~s~] ~b~- ~s~' ..
                                                       ESX.PlayerData.inventory[i].label, nil, {
                                RightLabel = "→"
                            }, true, function(Hovered, Active, Selected)
                                if (Selected) then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'weapon'), true, true, true, function()
                    ...
                    for i = 1, #VM.WeaponData, 1 do
                        if HasPedGotWeapon(VM.Ped, VM.WeaponData[i].hash, false) then
                            ...
                            RageUI.ButtonWithStyle('[~r~' .. ammo .. '~s~] ~b~- ~s~' .. VM.WeaponData[i].label, nil, {
                                RightLabel = "→"
                            }, true, function(Hovered, Active, Selected)
                                if (Selected) then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'weapon_use'), true, true, true, function()
                    RageUI.ButtonWithStyle('Donner des ~r~munitions', nil, {
                        RightBadge = RageUI.BadgeStyle.Ammo
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            ...
                            if post then
                                ...
                                if closestDistance ~= -1 and closestDistance <= 3 then
                                    ...
                                    DrawMarker(2, x, y, z + 1.5, 0, 0, 0, 180.0, nil, nil, 0.5, 0.5, 0.5, 0, 0, 255,
                                        120, true, true, p19, true)
                                    ...
                                    if IsPedOnFoot(closestPed) then
                                        ...
                                        if ammo > 0 then
                                            if quantity <= ammo and quantity >= 0 then
                                                ...
                                                TriggerServerEvent('VMLife:Weapon_addAmmoToPedS',
                                                    GetPlayerServerId(closestPlayer), VM.ItemSelected.name, quantity)
                                                ShowAboveRadarMessage('Vous avez donné x%s munitions à %s', quantity,
                                        ...
                                        ShowAboveRadarMessage(
                                            'Vous ne pouvez pas donner des munitions dans un ~~r~véhicule~s~',
                                            VM.ItemSelected.label)
                                    end
                                else
                    ...
                    RageUI.ButtonWithStyle("Jeter ~g~l'arme", nil, {
                        ...
                        if Selected then
                            if IsPedOnFoot(VM.Ped) then
                                ...
                                ShowAboveRadarMessage("~r~Impossible~s~ de jeter l'armes dans un véhicule",
                                    VM.ItemSelected.label)
                            end
                        end
                    end)
                    ...
                    if HasPedGotWeapon(VM.Ped, VM.ItemSelected.hash, false) then
                        RageUI.ButtonWithStyle("Donner ~g~l'arme", nil, {
                            RightBadge = RageUI.BadgeStyle.Gun
                        }, true, function(Hovered, Active, Selected)
                            if Selected then
                                local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                                ...
                                if closestDistance ~= -1 and closestDistance <= 3 then
                                    ...
                                    if IsPedOnFoot(closestPed) then
                                        ...
                                        TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(closestPlayer),
                                            'item_weapon', VM.ItemSelected.name, ammo)
                                        -- seAll()
                                    else
                                        ShowAboveRadarMessage('~r~Impossible~s~ de donner une arme dans un véhicule',
                                            VM.ItemSelected.label)
                                    end
                                else
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'inventaire_use'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Utiliser ~g~l'item", nil, {
                    ...
                    RageUI.ButtonWithStyle("Jeter ~r~l'item", nil, {
                        RightBadge = RageUI.BadgeStyle.Alert
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            if VM.ItemSelected.canRemove then
                                local post, quantity = CheckQuantity(KeyboardInput(
                                    "Nombres d'items que vous voulez jeter", '', '', 100))
                                if post then
                                    if not IsPedSittingInAnyVehicle(PlayerPed) then
                                        TriggerServerEvent('esx:removeInventoryItem', 'item_standard',
                                            VM.ItemSelected.name, quantity)
                                        -- RageUI.CloseAll()
                                    end
                                end
                            end
                    ...
                    RageUI.ButtonWithStyle("Donner ~g~l'items", nil, {
                        RightBadge = RageUI.BadgeStyle.Tick
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            local sonner, quantity = CheckQuantity(KeyboardInput(
                                "Nombres d'items que vous voulez donner", '', '', 100))
                            local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                            local pPed = GetPlayerPed(-1)
                            local coords = GetEntityCoords(pPed)
                            local x, y, z = table.unpack(coords)
                            DrawMarker(2, x, y, z + 1.5, 0, 0, 0, 180.0, nil, nil, 0.5, 0.5, 0.5, 0, 0, 255, 120, true,
                                true, p19, true)
                            ...
                            if sonner then
                                if closestDistance ~= -1 and closestDistance <= 3 then
                                    ...
                                    if IsPedOnFoot(closestPed) then
                                        TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(closestPlayer),
                                            'item_standard', VM.ItemSelected.name, quantity)
                                        -- RageUI.CloseAll()
                                    else
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'portefeuille'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Emplois", nil, {
                        RightLabel = "~b~" .. ESX.PlayerData.job.label .. "~s~ →"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                        end
                    end, RMenu:Get('inventory', 'portefeuille_work'))
                    RageUI.ButtonWithStyle('💼 ~b~Mes Métiers', description, {
                        RightLabel = "~y~→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            RageUI.CloseAll()
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'portefeuille_use'), true, true, true, function()
                    ...
                    for i = 1, #ESX.PlayerData.accounts, 1 do
                        if ESX.PlayerData.accounts[i].name == 'black_money' then
                            RageUI.ButtonWithStyle("~r~Donner~s~ de l'argent non-déclaré", nil, {
                                RightBadge = RageUI.BadgeStyle.Lock
                            }, true, function(Hovered, Active, Selected)
                                if Selected then
                                    local black, quantity = CheckQuantity(KeyboardInput(
                                        "Somme d'argent que vous voulez donner", '', '', 1000))
                                    if black then
                                        local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                                        ...
                                        if closestDistance ~= -1 and closestDistance <= 3 then
                                            ...
                                            if not IsPedSittingInAnyVehicle(closestPed) then
                                                TriggerServerEvent('esx:giveInventoryItem',
                                                    GetPlayerServerId(closestPlayer), 'item_account',
                                                    ESX.PlayerData.accounts[i].name, quantity)
                                                -- RageUI.CloseAll()
                                            else
                                                ShowAboveRadarMessage(
                                                    _U('Vous ne pouvez pas donner ', 'de l\'argent dans un véhicles'))
                                            end
                                        else
                            ...
                            RageUI.ButtonWithStyle("~r~Jeter~s~ de l'argent non declaré", nil, {
                                RightBadge = RageUI.BadgeStyle.Tick
                            }, true, function(Hovered, Active, Selected)
                                if Selected then
                                    local black, quantity = CheckQuantity(KeyboardInput(
                                        "Somme d'argent que vous voulez jeter", '', '', 1000))
                                    if black then
                                        if not IsPedSittingInAnyVehicle(PlayerPed) then
                                            TriggerServerEvent('esx:removeInventoryItem', 'item_account',
                                                ESX.PlayerData.accounts[i].name, quantity)
                                            -- RageUI.CloseAll()
                                        else
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'portefeuille_work'), true, true, true, function()
                    RageUI.ButtonWithStyle("Grade", nil, {
                        RightLabel = "~b~" .. ESX.PlayerData.job.grade_label .. "~s~"
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                        end
                    end)
                    ...
                    if ESX.PlayerData.job and ESX.PlayerData.job.name == 'ademo' then
                        ...
                        RageUI.ButtonWithStyle("Démisionner", nil, {
                            RightBadge = RageUI.BadgeStyle.Alert,
                            Color = {
                                BackgroundColor = {
                                    154,
                    ...
                    if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.grade_name == 'boss' then
                        ...
                        RageUI.ButtonWithStyle("Gestion d'entreprise", nil, {
                            RightLabel = "→"
                        }, true, function(Hovered, Active, Selected)
                            if Selected then
                        ...
                        RageUI.ButtonWithStyle("Gestion d'entreprise", nil, {
                            RightBadge = RageUI.BadgeStyle.Lock
                        }, false, function(Hovered, Active, Selected)
                            if Selected then
                            end
                        end)
                    end
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'boos'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle('~r~Recruter~s~ une personne proche de vous', nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            if ESX.PlayerData.job.grade_name == 'boss' then
                                ...
                                if closestPlayer == -1 or closestDistance > 3.0 then
                                    ...
                                    TriggerServerEvent('vInventory:Boss_recruterplayer',
                                        GetPlayerServerId(closestPlayer), ESX.PlayerData.job.name, 0)
                                end
                            else
                    ...
                    RageUI.ButtonWithStyle('~g~Virer~s~ une personne proche de vous', nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            if ESX.PlayerData.job.grade_name == 'boss' then
                    ...
                    RageUI.ButtonWithStyle('~p~Promouvoir~s~ une personne proche de vous', nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            if ESX.PlayerData.job.grade_name == 'boss' then
                                ...
                                if closestPlayer == -1 or closestDistance > 3.0 then
                                    ...
                                    TriggerServerEvent('vInventory:Boss_promouvoirplayer',
                    ...
                    RageUI.ButtonWithStyle('~g~Destituer~s~ une personne proche de vous', nil, {
                        RightLabel = "→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            if ESX.PlayerData.job.grade_name == 'boss' then
                                ...
                                if closestPlayer == -1 or closestDistance > 3.0 then
                                    ...
                                    TriggerServerEvent('vInventory:Boss_destituerplayer',
                                        GetPlayerServerId(closestPlayer))
                                end
                            else
                                ShowAboveRadarMessage('Vous n\'avez pas les ~r~droits~w~')
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'portefeuille_money'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("~b~Donner~s~ de l'argent liquide", nil, {
                        RightBadge = RageUI.BadgeStyle.Lock
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                            local black, quantity = CheckQuantity(
                                KeyboardInput("Somme d'argent que vous voulez donner", '', '', 1000))
                            if black then
                                local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                                ...
                                if closestDistance ~= -1 and closestDistance <= 3 then
                                    ...
                                    if not IsPedSittingInAnyVehicle(closestPed) then
                                        TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(closestPlayer),
                                            'item_money', ESX.PlayerData.money, quantity)
                                        -- RageUI.CloseAll()
                                    else
                                        ShowAboveRadarMessage(
                                            _U('Vous ne pouvez pas donner ', 'de l\'argent dans un véhicles'))
                    ...
                    RageUI.ButtonWithStyle("~b~Jeter~s~ de l'argent liquide", nil, {
                        RightBadge = RageUI.BadgeStyle.Tick
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                            local black, quantity = CheckQuantity(
                                KeyboardInput("Somme d'argent que vous voulez jeter", '', '', 1000))
                            if black then
                                if not IsPedSittingInAnyVehicle(PlayerPed) then
                                    TriggerServerEvent('esx:removeInventoryItem', 'item_money', ESX.PlayerData.money,
                                        quantity)
                                    -- RageUI.CloseAll()
                                else
                                    ShowAboveRadarMessage('Vous pouvez pas jeter', 'de l\'argent')
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'menu'), true, true, true, function()
                    ...
                    RageUI.Separator("~r~↓~g~↓~b~↓ ~s~Choisi ta couleur préférée ! ~r~↓~g~↓~b~↓", nil,
                        {}, true, function(_, _, _)
                        end)

                    RageUI.Progress("Rouge", menuColor[1], 255, nil, true, true,
                        function(Hovered, Active, Selected, Color)
                            menuColor[1] = Color
                            ReloadColor()
                        end)

                    RageUI.Progress("Vert", menuColor[2], 255, nil, true, true,
                        function(Hovered, Active, Selected, Color)
                            menuColor[2] = Color
                            ReloadColor()
                        end)

                    RageUI.Progress("Bleu", menuColor[3], 255, nil, true, true,
                        function(Hovered, Active, Selected, Color)
                            menuColor[3] = Color
                            ReloadColor()
                        end)

                    RageUI.ButtonWithStyle("Sauvegarder la couleur", nil, {
                        RightBadge = RageUI.BadgeStyle.Tick
                    }, true, function(Hovered, Active, Selected)
                        if Selected then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'sante'), true, true, true, function()
                    ...
                    RageUI.SliderProgress("Faim", VM.AdemoFaim, 100, nil, {
                        ProgressColor = {
                            R = 0,
                            G = 255,
                            B = 124,
                    ...
                    RageUI.SliderProgress("Hydratation", VM.AdemoSoif, 100, nil, {
                        ProgressColor = {
                            R = 0,
                            G = 212,
                            B = 255,
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'divers'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Prendre en ~r~Otage", description, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                    ...
                    RageUI.ButtonWithStyle("Prendre sur le ~b~Dos", description, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'visual'), true, true, true, function()
                    ...
                    RageUI.Checkbox("Vue & lumières améliorées", description, VM.visual, {},
                    ...
                    RageUI.Checkbox("Vue & lumières améliorées ~r~2", description, VM.visual4, {},
                        function(Hovered, Selected, Active, Checked)
                            if Selected then
                                VM.visual4 = Checked
                                if Checked then
                    ...
                    RageUI.Checkbox("Vue & lumières améliorées ~g~3", description, VM.visual9, {},
                        function(Hovered, Selected, Active, Checked)
                            if Selected then
                                VM.visual9 = Checked
                                if Checked then
                    ...
                    RageUI.Checkbox("Vue lumineux", description, VM.visual7, {},
                        function(Hovered, Selected, Active, Checked)
                            if Selected then
                                VM.visual7 = Checked
                                if Checked then
                    ...
                    RageUI.Checkbox("Vue lumineux ~b~2", description, VM.visual10, {},
                        function(Hovered, Selected, Active, Checked)
                            if Selected then
                                VM.visual10 = Checked
                                if Checked then
                    ...
                    RageUI.Checkbox("Couleurs amplifiées", description, VM.visual2, {},
                        function(Hovered, Selected, Active, Checked)
                            if Selected then
                                VM.visual2 = Checked
                                if Checked then
                    ...
                    RageUI.Checkbox("Noir & blancs", description, VM.visual3, {},
                        function(Hovered, Selected, Active, Checked)
                            if Selected then
                                VM.visual3 = Checked
                                if Checked then
                    ...
                    RageUI.Checkbox("Visual 1", description, VM.visual5, {},
                        function(Hovered, Selected, Active, Checked)
                            if Selected then
                                VM.visual5 = Checked
                                if Checked then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'utils'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Nombres de Citoyens :", description, {
                        RightLabel = "[~r~ " .. #players .. " ~s~] joueur(s) en ~g~ligne"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    end)

                    RageUI.ButtonWithStyle("Contact Admin", description, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                    ...
                    RageUI.ButtonWithStyle('Touche Serveur', description, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Rejoindre le ~b~Discord", description, {
                        RightLabel = "→→"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'tserv'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Ouvrir/Fermer Téléphone :", description, {
                        RightLabel = "~b~F1"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Inventaire:", description, {
                        RightLabel = "~b~F2"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Gestion Vetements:", description, {
                        RightLabel = "~b~Y"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Gestion clés / Véhicule:", description, {
                        RightLabel = "~b~F7"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Coffre:", description, {
                        RightLabel = "~b~K"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    end)
                    RageUI.ButtonWithStyle("Boite à gants:", description, {
                        RightLabel = "~b~F2"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Gestion Animations :", description, {
                        RightLabel = "~b~F5"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Portée de la voix:", description, {
                        RightLabel = "~b~Shift~w~+~g~ H"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    end)

                    RageUI.ButtonWithStyle("Screenshot :", description, {
                        RightLabel = "~b~F12"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Lever les mains en l'air :", description, {
                        RightLabel = "~b~X"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                    ...
                    RageUI.ButtonWithStyle("Pointer du doigt :", description, {
                        RightLabel = "~b~B"
                    }, true, function(Hovered, Active, Selected)
                        if (Selected) then
                        end
                ...
                RageUI.IsVisible(RMenu:Get('inventory', 'clothesbase'), true, true, true, function()
                    RageUI.ButtonWithStyle("Vetements", nil, {
                        RightLabel = "→"
                    }, true, function()
                    end, RMenu:Get('inventory', 'clothes'))
                    RageUI.ButtonWithStyle("Accessories", nil, {
                        RightLabel = "→"
                    }, true, function()
