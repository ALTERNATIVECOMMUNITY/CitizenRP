...
-- You can disable the (F3) menu here / change the keybind.
	...
	MenuKeybind = 318, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://cdn.discordapp.com/attachments/477543918599143424/896432668227547176/emotes-banner.png",
