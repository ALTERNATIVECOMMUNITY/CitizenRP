...
RegisterNUICallback('updateSkin', function(data)
    ...
    if changed(dad, data.dad) or changed(mum, data.mum) or changed(morfpercent, data.morfpercent) or
        changed(skintone, data.skintone) or changed(sexo, data.sex) then
    ...
    if changed(eyebrow, data.eyebrow) or changed(eyebrowopacity, data.eyebrowopacity) or
        changed(eyebrowcolor, data.eyebrowcolor) then
