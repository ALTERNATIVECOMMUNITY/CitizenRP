...
Labels = {
  ...
  key_shop_helptxt  = "~INPUT_PICKUP~ за магазина",
  key_shop_bliptxt  = "Магазин за ключове",
  ...
  Doors = {
    {
      ...
      objects = {
        -- Each door object held in its own table.
        {
          ...
          door_model = GetHashKey('v_ilev_ph_door012'),
          door_loc   = vector3(434.747,-980.618,30.839),
          door_rot   = vector3(0.0,0.0,-90.0),
        },
        {
          reposition = false,
          door_model = GetHashKey('v_ilev_ph_door0022'),
