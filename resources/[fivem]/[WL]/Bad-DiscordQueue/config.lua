...
--	['Citoyens'] = {500, "Tu es sur la rocade ! [{QUEUE_NUM}/{QUEUE_MAX}]:"},
	['vip'] = {200, "Tu es sur la rocade ! (VIP) [{QUEUE_NUM}/{QUEUE_MAX}]:"},
	['Testeur'] {200, "Tu es sur la rocade ! (Testeur) [{QUEUE_NUM}/{QUEUE_MAX}]:"},

	['Streamer'] = {100, "Rocade spéciale press [{QUEUE_NUM}/{QUEUE_MAX}]:"},

	['MODERATION'] = {50, "Rocade Modérateur [{QUEUE_NUM}/{QUEUE_MAX}]:"},

	['Dev'] = {30, "Rocade des geeks. [{QUEUE_NUM}/{QUEUE_MAX}]:"},
	['Gestions'] = {20, "Rocade des semi-dieux. [{QUEUE_NUM}/{QUEUE_MAX}]:"},
	['Fonda'] = {1, "Rocade des dieux. [{QUEUE_NUM}/{QUEUE_MAX}]:"},
}
