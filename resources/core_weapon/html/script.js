...
function open(data) {
  ...
  var myvar = '<div class="clearfix" id="page"><!-- group -->' +
    ...
    '       <p>VISEUR</p>' +
    '      </div>' +
    '      <div class="rgba-background colelem" id="u284" style="opacity:1.0; background:rgba(9, 9, 9, 0.5) url(img/scope.png) no-repeat center center; background-size:cover;"><!-- simple frame --></div>' +
